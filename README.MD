 ## multissh
参考：https://github.com/shanghai-edu/multissh
...
####加了一个交互操作的
```
go run main.go -I -hosts "192.168.0.130" -u test -p passwd                
2020/04/08 10:15:05 Multissh start
Last login: Tue Apr  7 17:45:44 2020 from 192.168.0.102
[test@localhost ~]$
[test@localhost ~]$
[test@localhost ~]$
[test@localhost ~]$ ls
